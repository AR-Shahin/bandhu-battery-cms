        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route("admin.services.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-form.input label="Title" type="text" name="title" placeholder="Enter title" id="title"/>
                        </div>
                        <div class="col-md-6">
                            <x-form.input label="Icon" type="text" name="icon" placeholder="Enter icon" id="icon"/>
                        </div>
                        <div class="col-md-6">
